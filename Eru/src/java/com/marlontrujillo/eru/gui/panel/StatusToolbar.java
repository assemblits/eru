package com.marlontrujillo.eru.gui.panel;

import com.marlontrujillo.eru.alarming.AlarmsController;
import com.marlontrujillo.eru.reporting.ReportExportationController;
import com.marlontrujillo.eru.util.Constants;
...
import ve.marlontrujillo.scene.control.Display;
...
public class  StatusToolbar extends VBox implements Initializable {
    ...
    @FXML private void fullscreenMenuItemFired(ActionEvent actionEvent) {
        owner.setFullScreen(!owner.isFullScreen());
    }

    @FXML private void screenshotMenuItemFired(ActionEvent actionEvent) {
    ...
    @FXML private void exportExcelMenuItemFired(ActionEvent actionEvent) {
        final Stage exportationStage = new Stage();
        exportationStage.setScene(new Scene(new ReportExportationController()));
