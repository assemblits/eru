...
class JFXClassUtilTest extends Specification {
    ...
    def 'isJFXComponentClass should return false for class which is not JFX component'() {
        ...
        when:
        def isJFXComponentClass = jfxClassUtil.isJFXComponentClass('NoJFX', 'JFXClassUtilTest.NoJFX')
        then:
        !isJFXComponentClass
    }
    ...
    def 'isJFXComponentClass should return false for null class name'() {
        when:
        def isJFXComponentClass = jfxClassUtil.isJFXComponentClass(null, 'EruAlarm')
        then:
        !isJFXComponentClass
    }
