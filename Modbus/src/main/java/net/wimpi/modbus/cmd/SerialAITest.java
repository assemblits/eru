...
public class SerialAITest {
  ...
  private static void printUsage() {
    System.out.println(
        "java net.wimpi.SerialAITest <portname [String]>  <Unit Address [int8]> <register [int16]> <wordcount [int16]> {<repeat [int]>}"
    );
  }//printUsage
