...
public class AIAOTest {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      //6. Close the transmission
      con.close();
    }
  }//main

  private static void printUsage() {
    System.out.println("java net.wimpi.AIAOTest <address{:<port>} [String]> <register a_in [int16]> <register a_out [int16]>");
  }//printUsage
