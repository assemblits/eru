...
public class ModbusTCPTransaction
  ...
  /**
   * Sets the transmission on which this <tt>ModbusTransaction</tt>
   ...
   * transmission is openend and closed for
  ...
  /**
   * Tests if the transmission will be openend
  ...
  public void execute() throws
    ...
    try {
      ...
      //3. open the transmission if not connected
      ...
      //6. close transmission if reconnecting
      if (isReconnecting()) {
        m_Connection.close();
      }
