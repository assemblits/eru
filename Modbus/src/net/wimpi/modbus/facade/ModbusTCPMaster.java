...
public class ModbusTCPMaster {
   ...
   *
   * @throws Exception if the transmission cannot be established.
   */
  public void connect()
      throws Exception {
   ...
   * constant transmission or reconnect for every transaction.
   *
   * @param b true if a new transmission should be established for each
  ...
  /**
   * Tests if a constant transmission is maintained or if a new
   * transmission is established for every transaction.
   *
   * @return true if a new transmission should be established for each
   *         transaction, false otherwise.
   */
