...
import eu.hansolo.enzo.skin.LcdSkin;
...
public class Lcd extends Control {
    ...
    public static enum LcdDesign {
        ...
        GREEN_DARKGREEN    (STYLE_CLASS_GREEN_DARKGREEN),
        BLUE2              (STYLE_CLASS_BLUE2),
        BLUE_BLACK         (STYLE_CLASS_BLUE_BLACK),
        BLUE_DARKBLUE      (STYLE_CLASS_BLUE_DARKBLUE),
        BLUE_LIGHTBLUE     (STYLE_CLASS_BLUE_LIGHTBLUE),
        BLUE_GRAY          (STYLE_CLASS_BLUE_GRAY),
        STANDARD           (STYLE_CLASS_STANDARD),
        LIGHTGREEN         (STYLE_CLASS_LIGHTGREEN),
        STANDARD_GREEN     (STYLE_CLASS_STANDARD_GREEN),
        BLUE_BLUE          (STYLE_CLASS_BLUE_BLUE),
        RED_DARKRED        (STYLE_CLASS_RED_DARKRED),
        DARKBLUE           (STYLE_CLASS_DARKBLUE),
        PURPLE             (STYLE_CLASS_PURPLE),
        BLACK_RED          (STYLE_CLASS_BLACK_RED),
        DARKGREEN          (STYLE_CLASS_DARKGREEN),
        AMBER              (STYLE_CLASS_AMBER),
        LIGHTBLUE          (STYLE_CLASS_LIGHTBLUE),
        GREEN_BLACK        (STYLE_CLASS_GREEN_BLACK),
        YELLOW_BLACK       (STYLE_CLASS_YELLOW_BLACK),
        BLACK_YELLOW       (STYLE_CLASS_BLACK_YELLOW),
        LIGHTGREEN_BLACK   (STYLE_CLASS_LIGHTGREEN_BLACK),
        DARKPURPLE         (STYLE_CLASS_DARKPURPLE),
        DARKAMBER          (STYLE_CLASS_DARKAMBER),
        BLUE_LIGHTBLUE2    (STYLE_CLASS_BLUE_LIGHTBLUE2),
        GRAY_PURPLE        (STYLE_CLASS_GRAY_PURPLE),
        SECTIONS           (STYLE_CLASS_SECTIONS),
        YOCTOPUCE          (STYLE_CLASS_YOCTOPUCE),
        FLAT_TURQOISE      (STYLE_CLASS_FLAT_TURQOISE),
        FLAT_GREEN_SEA     (STYLE_CLASS_FLAT_GREEN_SEA),
        FLAT_EMERLAND      (STYLE_CLASS_FLAT_EMERLAND),
        FLAT_NEPHRITIS     (STYLE_CLASS_FLAT_NEPHRITIS),
        FLAT_PETER_RIVER   (STYLE_CLASS_FLAT_PETER_RIVER),
        FLAT_BELIZE_HOLE   (STYLE_CLASS_FLAT_BELIZE_HOLE),
        FLAT_AMETHYST      (STYLE_CLASS_FLAT_AMETHYST),
        FLAT_WISTERIA      (STYLE_CLASS_FLAT_WISTERIA),
        FLAT_SUNFLOWER     (STYLE_CLASS_FLAT_SUNFLOWER),
        FLAT_ORANGE        (STYLE_CLASS_FLAT_ORANGE),
        FLAT_CARROT        (STYLE_CLASS_FLAT_CARROT),
        FLAT_PUMPKIN       (STYLE_CLASS_FLAT_PUMPKIN),
        FLAT_ALIZARIN      (STYLE_CLASS_FLAT_ALIZARIN),
        FLAT_POMEGRANATE   (STYLE_CLASS_FLAT_POMEGRANATE),
        FLAT_CLOUDS        (STYLE_CLASS_FLAT_CLOUDS),
        FLAT_SILVER        (STYLE_CLASS_FLAT_SILVER),
        FLAT_CONCRETE      (STYLE_CLASS_FLAT_CONCRETE),
        FLAT_ASBESTOS      (STYLE_CLASS_FLAT_ASBESTOS),
        FLAT_WET_ASPHALT   (STYLE_CLASS_FLAT_WET_ASPHALT),
        FLAT_MIDNIGHT_BLUE (STYLE_CLASS_FLAT_MIDNIGHT_BLUE);

        public final String STYLE_CLASS;

        private LcdDesign(final String STYLE_CLASS) {
...
//            }
    ...
    public final LcdDesign getLcdDesign() { return null == lcdDesign ? LcdDesign.STANDARD : lcdDesign.get(); }
    public final void setLcdDesign(final LcdDesign LCD_DESIGN) {
        lcdDesignProperty().set(LCD_DESIGN);
    }
    public final ObjectProperty<LcdDesign> lcdDesignProperty() {
        if (null == lcdDesign) {
            lcdDesign = new ObjectPropertyBase<LcdDesign>(LcdDesign.STANDARD) {
                @Override public void set(final LcdDesign LCD_DESIGN) {
                    super.set(LCD_DESIGN);
                    getStyleClass().setAll("lcd", LCD_DESIGN.STYLE_CLASS);
                }
                @Override public Object getBean() { return Lcd.this; }
