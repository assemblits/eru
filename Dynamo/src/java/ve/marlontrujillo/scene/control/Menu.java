package ve.marlontrujillo.scene.control;
...
public class Menu {
     ...
     */
    public Menu(Node node, MouseButton mouseButton)
    {
    ...
    private void construct(Node node, MouseButton mouseButton)
    {
        ...
        circularPane.setArc(180.0);
        circularPane.setGap(-70.0);
...
//         circularPane.setShowDebug(javafx.scene.paint.Color.GREEN);
    ...
    public Menu withAnimationDuration(Duration value) { setAnimationDuration(value); return this; }
    ...
    public Menu withAnimationInterpolation(AnimationInterpolation value) { setAnimationInterpolation(value); return this; }
